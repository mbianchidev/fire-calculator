...
export const SettingsPage: React.FC<SettingsPageProps> = ({ onSettingsChange }) => {
  ...
  const handleSettingChange = <K extends keyof UserSettings>(key: K, value: UserSettings[K]) => {
    ...
    // If theme is changed, also update via useTheme hook
      ...
      <div className="settings-container">
        ...
        <section className="settings-section">
          ...
          <div className="setting-item">
            <div className="label-with-tooltip">
              <label>Theme</label>
              <Tooltip content="Choose your preferred color scheme. Light mode uses bright colors, dark mode is easier on the eyes in low light, and system follows your device's theme preference.">
                <span className="info-icon" aria-label="More information">i</span>
              </Tooltip>
            </div>
